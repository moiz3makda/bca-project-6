...
public partial class User_List : System.Web.UI.Page
{
    ...
    protected void search_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select id,name,address,state,city,mobile_no,gender,email_id,date_of_birth,education_status,key_skills from user_reg where key_skills='" + search1.Text + "'",con);
