    ...
    <table align="center" border="10" width="1000">
        ...
        <tr>
            <td style="width: 857px">
                <asp:Label ID="Label2" runat="server" Text="Type of Company:"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="cstat" runat="server"></asp:TextBox>
                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                    ControlToValidate="cstat" ErrorMessage="plz enter your state" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 857px">
            ...
            <td>
                <asp:TextBox ID="cct" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                    ControlToValidate="cadd" ErrorMessage="plz enter your address:" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 857px">
        ...
        <tr>
            <td style="height: 231px">
                <asp:Label ID="Label8" runat="server" Text="Comapny Description:"></asp:Label>
            </td>
            <td style="height: 231px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                    ControlToValidate="cdisc" ErrorMessage=" enter your company's description"
                    ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                <asp:TextBox ID="cdisc" runat="server" Height="300" TextMode="MultiLine" Width="500"></asp:TextBox></td>
        </tr>
        <tr>
                    <td align="center" colspan="2">
                        <asp:Label ID="Label12" Font-Size="Large" runat="server" Text="your Login Details"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
