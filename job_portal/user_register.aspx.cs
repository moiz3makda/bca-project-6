        ...
        if (ures.HasFile)
        {
            try
            {
                ...
                if (type != String.Empty)
                {
                    ...
                    query = "insert into user_reg(name,address,state,city,mobile_no,gender,email_id,date_of_birth,filename,education_status,key_skills,filetype,filedata,unm,pwd)" + "values('" + uname.Text + "','" + uadd.Text + "','" + ustat.Text + "','" + uct.Text + "','" + umob.Text + "','" + gender + "','" + umail.Text + "','" + udt.Text + "',@filename,'" + ued.Text + "','" + uskill.Text + "',@filetype,@filedata,'" + unm.Text + "','" + pwd.Text + "')";
